...
const ClassTypesGrid = styled.div`
  display: grid;
...
export default function JiuJitsuPricing() {
  return (
    <PageContainer>
      <Navigation />
      <PricingSection>
        <Container>
          <Title>Jiu-Jitsu Only Membership</Title>
          <Subtitle>Unlimited Jiu-Jitsu Classes</Subtitle>
          <Description>
            Focus on mastering the art of Brazilian Jiu-Jitsu. This membership gives you 
            unlimited access to all Jiu-Jitsu classes, from fundamentals to advanced techniques. 
            Perfect for those who want to specialize in the art of ground fighting.
          </Description>
          
          <MainPricingCard>
            <CardTitle>Unlimited Jiu-Jitsu</CardTitle>
            <Price>
              <span className="currency">$</span>150
              <span className="period">/month</span>
            </Price>
            <Features>
              <Feature>Unlimited Beginner Jiu-Jitsu classes</Feature>
              <Feature>Unlimited Advanced Jiu-Jitsu classes</Feature>
              <Feature>Access to Open Mat sessions</Feature>
              <Feature>No-Gi training only</Feature>
              <Feature>Competition preparation</Feature>
          ...
          <InfoSection>
            ...
            <p>
              The Jiu-Jitsu Only membership provides comprehensive training in Brazilian Jiu-Jitsu. 
              You'll learn self-defense, sport techniques, and develop the mental discipline that 
              comes with mastering this martial art. Our curriculum follows traditional BJJ 
              progression while incorporating modern training methods.
            </p>
          </InfoSection>
          ...
          <ClassTypesGrid>
            <ClassTypeCard>
              ...
              <p>Learn fundamentals, basic techniques, and build a strong foundation</p>
            </ClassTypeCard>
            <ClassTypeCard>
              <h4>Advanced Classes</h4>
              <p>Master complex techniques, advanced strategies, and competition skills</p>
            </ClassTypeCard>
            <ClassTypeCard>
              <h4>Open Mat</h4>
              <p>Unstructured training time for practice, drilling, and sparring</p>
            </ClassTypeCard>
            <ClassTypeCard>
              <h4>No-Gi Training</h4>
              <p>Modern BJJ without the kimono, emphasizing speed and athleticism</p>
            </ClassTypeCard>
            <ClassTypeCard>
              <h4>Competition Prep</h4>
              <p>Specialized training for tournament preparation and competition</p>
            </ClassTypeCard>
          </ClassTypesGrid>
          ...
          <InfoSection>
            ...
            <p>
              Our Jiu-Jitsu program follows the traditional Brazilian Jiu-Jitsu belt system. 
              Students progress from white belt through blue, purple, brown, and black belts. 
              Each promotion represents significant growth in technique, knowledge, and character. 
              Our instructors evaluate students based on skill, dedication, and time on the mats.
            </p>
          </InfoSection>
          ...
          <InfoSection>
            ...
            <p>
              We believe in the technical mastery philosophy of Brazilian Jiu-Jitsu. Our training 
              emphasizes technique over strength, leverage over power, and continuous learning 
              over ego. Whether you're training for self-defense, sport, or personal development, 
              our Jiu-Jitsu program will challenge and inspire you.
            </p>
          </InfoSection>
          
          <ContactInfo>
            <h3>Ready to Start Your Jiu-Jitsu Journey?</h3>
