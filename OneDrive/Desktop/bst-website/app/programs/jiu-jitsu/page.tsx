  ...
  return (
    <PageContainer>
      ...
      <Content>
        ...
        <HeroSection>
          <Title style={{ fontSize: '3rem', marginBottom: '0.5rem' }}>BLOOD SWEAT AND TEARS COMP TEAM</Title>
          <Subtitle style={{ fontSize: '1rem', marginBottom: '1rem' }}>Join the beginning of a new generation of Jiu-Jitsu in New England</Subtitle>
        </HeroSection>

        <Section>
          <Text>
            The BSTs Competition Team proudly secured second place overall at the recent Grappling Industries event. 
            This remarkable achievement showcases the hard work, dedication, and skill of our athletes. Our team members 
            demonstrated exceptional technique and sportsmanship, representing BST with pride. We look forward to building 
            on this success in future competitions!
          </Text>
          <Text>
            <strong>JOIN THE BEGINNING OF NEW GENERATION OF JIU JITSU IN NEW ENGLAND</strong>
          </Text>
          <Text>
